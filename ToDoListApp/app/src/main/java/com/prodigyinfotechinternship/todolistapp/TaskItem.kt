...
class TaskItem(
    ...
    private fun purple(context: Context) = ContextCompat.getColor(context, R.color.chineseViolet)
    private fun black(context: Context) = ContextCompat.getColor(context, R.color.mountbattenPink)
